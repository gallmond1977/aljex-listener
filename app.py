...
def init_db():
    ...
    # leads_status, deleted_leads, manual_leads, lead_quotes, app_meta,
    # customer_assignments, service_assignments, service_notes, and
    # customer_contacts all live in crm.py now (see init_crm_db(), called
    # alongside this function at the bottom of this file) - not here.
